...
chef-server-ctl org-create extended_org "Default organization" --association_user admin --filename /etc/chef/extended_org-validator.pem
...
cd /etc/chef/ && tar -cvzf knife_admin_key.tar.gz admin.pem extended_org-validator.pem
echo -e "\nRestart Nginx..."
